...
let askSpread, bidSpread, goldHigh, goldLow, goldValue, silverBidSpread, silverAskSpread, goldBuy, goldSell, silverBuy, silverSell, silverValue, goldValueUSD;
...
async function readSpreadValues() {
    try {
        const uid = 'suS8O6sTxXcGg36oaTgZ1yRvERz1';
        if (!uid) {
